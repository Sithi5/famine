        ...
        if (((char *)famine->payload_data)[i] == 0x66)
        {
            if (famine->payload_size - i > 17)
            {
                ...
                if (((char *)famine->payload_data)[i + 1] == 0x66 && ((char *)famine->payload_data)[i + 2] == 0x66 &&
                    ((char *)famine->payload_data)[i + 3] == 0x66 &&
                    ((char *)famine->payload_data)[i + 4] == 0x48 && ((char *)famine->payload_data)[i + 5] == 0x2d &&
                    ((char *)famine->payload_data)[i + 6] == 0x66 && ((char *)famine->payload_data)[i + 7] == 0x66 &&
                    ((char *)famine->payload_data)[i + 8] == 0x66 && ((char *)famine->payload_data)[i + 9] == 0x66 &&
                    ((char *)famine->payload_data)[i + 10] == 0x48 && ((char *)famine->payload_data)[i + 11] == 0x05 &&
                    ((char *)famine->payload_data)[i + 12] == 0x66 && ((char *)famine->payload_data)[i + 13] == 0x66 &&
                    ((char *)famine->payload_data)[i + 14] == 0x66 && ((char *)famine->payload_data)[i + 15] == 0x66)
                {
        ...
        if (((char *)famine->payload_data)[i] == 0x22)
        {
            if (famine->payload_size - i > 17)
            {
                ...
                if (((char *)famine->payload_data)[i + 1] == 0x22 && ((char *)famine->payload_data)[i + 2] == 0x22 &&
                    ((char *)famine->payload_data)[i + 3] == 0x22 &&
                    ((char *)famine->payload_data)[i + 4] == 0x48 && ((char *)famine->payload_data)[i + 5] == 0x2d &&
                    ((char *)famine->payload_data)[i + 6] == 0x22 && ((char *)famine->payload_data)[i + 7] == 0x22 &&
                    ((char *)famine->payload_data)[i + 8] == 0x22 && ((char *)famine->payload_data)[i + 9] == 0x22 &&
                    ((char *)famine->payload_data)[i + 10] == 0x48 && ((char *)famine->payload_data)[i + 11] == 0x05 &&
                    ((char *)famine->payload_data)[i + 12] == 0x22 && ((char *)famine->payload_data)[i + 13] == 0x22 &&
                    ((char *)famine->payload_data)[i + 14] == 0x22 && ((char *)famine->payload_data)[i + 15] == 0x22)
                {
...
size_t find_keysection_offset_elf64(t_famine *famine)
{
    for (size_t i = 0; i < famine->payload_size; i++)
    {
        if (((char *)famine->payload_data)[i] == 0x44)
        {
            if (famine->payload_size - i > 128)
            {
                if (((char *)famine->payload_data)[i + 1] == 0x44 && ((char *)famine->payload_data)[i + 2] == 0x44 && ((char *)famine->payload_data)[i + 3] == 0x44)
                {
                    return i;
                }
            }
    ...
    error(ERROR_KEYSECTION_NOT_FOUND, famine);
    return -1;
}
        ...
        if (((char *)famine->payload_data)[i] == 0x77)
        {
            if (famine->payload_size - i > 17)
            {
                ...
                if (((char *)famine->payload_data)[i + 1] == 0x77 && ((char *)famine->payload_data)[i + 2] == 0x77 &&
                    ...
                    ((char *)famine->payload_data)[i + 4] == 0x48 && ((char *)famine->payload_data)[i + 5] == 0x2d &&
                    ((char *)famine->payload_data)[i + 6] == 0x77 && ((char *)famine->payload_data)[i + 7] == 0x77 &&
                    ((char *)famine->payload_data)[i + 8] == 0x77 && ((char *)famine->payload_data)[i + 9] == 0x77 &&
                    ((char *)famine->payload_data)[i + 10] == 0x48 && ((char *)famine->payload_data)[i + 11] == 0x05 &&
                    ((char *)famine->payload_data)[i + 12] == 0x77 && ((char *)famine->payload_data)[i + 13] == 0x77 &&
                    ((char *)famine->payload_data)[i + 14] == 0x77 && ((char *)famine->payload_data)[i + 15] == 0x77)
                {
